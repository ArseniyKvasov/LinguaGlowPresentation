...
function handleWordListGeneration(result) {
    try {
        ...
        const container = document.querySelector('.wordlist-container');
        if (!container) {
...
function handleTrueOrFalseGeneration(result) {
    try {
        ...
        const container = document.querySelector('.truefalse-container');
        if (!container) {
...
function handleMakeASentenceGeneration(result) {
    try {
        ...
        const sentences = Array.isArray(parsedData)
            ? parsedData
        ...
        sentences.forEach(sentence => {
            if (sentence.sentence || sentence.correct) {
                addSentenceCard(cardsContainer, sentence.sentence || sentence.correct);
            }
        });
